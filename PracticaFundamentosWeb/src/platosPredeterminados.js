...
export default function () {
  ...
  platos.set (guisantes.getNombre(),guisantes);
  ...
  platos.set (paella.getNombre(),paella);
  ...
  platos.set (cocido.getNombre(),cocido);

  let macarrones = new Plato ('Albondigas', 'Deliciosas bolas de carne', 15, 10.0, new Map ([[0,'Carne de vacuno triturada'],[1,'Huevos'],[2,'Harina'],[3,'3 dientes de ajo '],[4,'1 cebolla']]), '../imagenes/Albondigas.jpeg');
  platos.set (macarrones.getNombre(),macarrones);

  let tortilla = new Plato ('Tortilla de patatas', 'La española', 11, 7.5, new Map ([[0,'Patatas'],[1,'Huevos'],[2,'Sal']]), '../imagenes/tortilla.jpeg');
  platos.set (tortilla.getNombre(),tortilla);
  ...
  platos.set (pizza.getNombre(),pizza);
  ...
  platos.set(lubina.getNombre(), lubina);
  ...
  platos.set (bravas.getNombre(),bravas);
  ...
  platos.set (tarta.getNombre(),tarta);
